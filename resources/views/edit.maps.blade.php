            ...
            <div class="card card-info card-outline">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ $marker->name }}"
                                    required>
                            </div>
                            <div class="form-group">
                                <label>Latitude:</label>
                                <input type="text" name="latitude" class="form-control"
                                    value="{{ $marker->latitude }}" required>
                            </div>
                            <div class="form-group">
                                <label>Longitude:</label>
                                <input type="text" name="longitude" class="form-control"
                                    value="{{ $marker->longitude }} required>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
                                <button class="btn btn-success" type="button"
                                    onclick="submitValid({{ $marker->id }})" data-toggle="tooltip"
                                    data-placement="top" title="Simpan">
